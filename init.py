...
def index():
	...
	return render_template('home.html',result=f.read().replace("\n", ""))
@app.route('/home')
def home():
	f=open("/var/www/html/data.json", "r")
	return render_template('home.html',result=f.read().replace("\n", ""))
...
def cart():
	...
	f=open("/var/www/html/data.json", "r")
	return render_template ('cart.html', form = form,result=f.read().replace("\n", ""))
...
def checkout():
	...
	return render_template('checkout.html',cartDetails='')
